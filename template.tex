...
\titlegraphic{
	...
	\includegraphics[height=1cm]{UL_actu}\quad
	\includegraphics[height=1cm]{DotLayer}\quad
	\includegraphics[height=1cm]{crdm_fr}\quad
	\includegraphics[height=1cm]{graal}\quad
	\includegraphics[height=1cm]{quantact}\quad
	% \includegraphics[height=1cm]{uqam.png}
}
